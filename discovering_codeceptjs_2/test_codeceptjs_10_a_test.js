...
npx codeceptjs run --steps test_codeceptjs_10_a_test.js
npx codeceptjs run --steps --verbose test_codeceptjs_10_a_test.js

# with the stepByStepReport plugin
npx codeceptjs run --plugins stepByStepReport --steps test_codeceptjs_10_a_test.js

#with the stepByStepReport images + allure reports
npx codeceptjs run --plugins allure --plugins stepByStepReport  --steps test_codeceptjs_10_a_test.js


#with the stepByStepReport images + allure reports
npx codeceptjs run --plugins stepByStepReport --plugins allure --steps test_codeceptjs_10_a_test.js


npx codeceptjs run --steps --grep "@post" test_codeceptjs_10_a_test.js
npx codeceptjs run --steps --verbose --grep "@post" test_codeceptjs_10_a_test.js
...
Scenario('Check WP Backoffice Journalist profile creation', async (I) => {
    ...
    */
    ...
    // V1 using an Actor
    // I.WpLogin(globalData.LOGIN_USERNAME, globalData.LOGIN_PASSWORD);
    ...
    I.say('\n--- Connection made with function WpLogin. Check steps_file.js');
/*
