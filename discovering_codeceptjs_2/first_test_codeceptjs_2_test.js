...
npx codeceptjs run --steps first_test_codeceptjs_1_test.js
npx codeceptjs run --steps --verbose first_test_codeceptjs_1_test.js


npx codeceptjs run --steps --grep "@starting" first_test_codeceptjs_1_test.js
npx codeceptjs run --steps --verbose --grep "@starting" first_test_codeceptjs_1_test.js
