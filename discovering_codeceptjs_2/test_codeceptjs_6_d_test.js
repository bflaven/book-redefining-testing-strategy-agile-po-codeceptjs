...
npx codeceptjs run --steps test_codeceptjs_6_d_test.js
npx codeceptjs run --steps --verbose test_codeceptjs_6_d_test.js



npx codeceptjs run --steps --grep "@post" test_codeceptjs_6_d_test.js
npx codeceptjs run --steps --verbose --grep "@post" test_codeceptjs_6_d_test.js
