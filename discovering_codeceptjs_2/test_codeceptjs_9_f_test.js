...
npx codeceptjs run --steps test_codeceptjs_9_f_test.js
npx codeceptjs run --steps --verbose test_codeceptjs_9_f_test.js

# with the stepByStepReport plugin
npx codeceptjs run --plugins stepByStepReport --steps test_codeceptjs_9_f_test.js

#with the stepByStepReport images + allure reports
npx codeceptjs run --plugins allure --plugins stepByStepReport  --steps test_codeceptjs_9_f_test.js


#with the stepByStepReport images + allure reports
npx codeceptjs run --plugins stepByStepReport --plugins allure --steps test_codeceptjs_9_f_test.js


npx codeceptjs run --steps --grep "@post" test_codeceptjs_9_f_test.js
npx codeceptjs run --steps --verbose --grep "@post" test_codeceptjs_9_f_test.js
