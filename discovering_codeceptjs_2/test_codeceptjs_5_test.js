...
npx codeceptjs run --steps test_codeceptjs_5_test.js
npx codeceptjs run --steps --verbose test_codeceptjs_5_test.js


npx codeceptjs run --steps --grep "@starting" test_codeceptjs_5_test.js
npx codeceptjs run --steps --verbose --grep "@starting" test_codeceptjs_5_test.js
